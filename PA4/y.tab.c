...
{
       0,   117,   117,   126,   127,   130,   131,   134,   135,   138,
     139,   140,   143,   144,   147,   150,   151,   154,   155,   158,
     161,   162,   165,   166,   169,   170,   171,   172,   173,   174,
     177,   178,   181,   182,   185,   186,   189,   190,   193,   196,
     199,   202,   205,   208,   211,   212,   213,   214,   215,   216,
     219,   222,   223,   224,   225,   226,   229,   230,   231,   232,
     235,   236,   237,   238,   241,   242,   245,   246,   249,   250,
     251,   252,   255,   256,   259,   260,   263,   266,   267,   268,
     269,   272,   275,   276,   277,   280,   281,   282,   283,   284,
     287,   288
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LOWER_THAN_ELSE", "$accept", "ram", "DeclList", "Decl",
...
#line 135 "parser.y" /* yacc.c:1646  */
    { (yyval.varDecl) = new VarDecl(new Identifier((yylsp[-3]), (yyvsp[-3].identifier)), (yyvsp[-4].varType), (yyvsp[-1].expr)); }
...
#line 219 "parser.y" /* yacc.c:1646  */
    { (yyval.assignExpr) = new AssignExpr((yyvsp[-2].expr), (yyvsp[-1].op), (yyvsp[0].expr)); }
...
#line 259 "parser.y" /* yacc.c:1646  */
    { (yyval.expr) = new Call((yylsp[-2]), NULL, (yyvsp[-2].fnid), new List<Expr*>()); }
#line 2064 "y.tab.c" /* yacc.c:1646  */
    break;

  case 75:
#line 260 "parser.y" /* yacc.c:1646  */
    { (yyval.expr) = new Call((yylsp[-1]), NULL, (yyvsp[-1].fnid), new List<Expr*>()); }
#line 2070 "y.tab.c" /* yacc.c:1646  */
    break;

  case 76:
#line 263 "parser.y" /* yacc.c:1646  */
    { (yyval.expr) = new Call((yylsp[-2]), NULL, (yyvsp[-2].fnid), (yyvsp[0].exprList)); }
#line 2076 "y.tab.c" /* yacc.c:1646  */
    break;

  case 77:
#line 266 "parser.y" /* yacc.c:1646  */
    { ((yyval.exprList) = new List<Expr*>())->Append((yyvsp[0].assignExpr)); }
#line 2082 "y.tab.c" /* yacc.c:1646  */
    break;

  case 78:
#line 267 "parser.y" /* yacc.c:1646  */
    { ((yyval.exprList) = (yyvsp[-2].exprList))->Append((yyvsp[0].assignExpr)); }
...
#line 272 "parser.y" /* yacc.c:1646  */
    { (yyval.fnid) = new Identifier((yylsp[0]), (yyvsp[0].identifier)); }
#line 2106 "y.tab.c" /* yacc.c:1646  */
    break;

  case 82:
#line 275 "parser.y" /* yacc.c:1646  */
    { (yyval.expr) = new VarExpr((yylsp[0]), new Identifier((yylsp[0]), (yyvsp[0].identifier))); }
